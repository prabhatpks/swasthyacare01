    ...
    <div className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12 dark:text-white">Core Medical Services</h2>
              ...
              return (
                <Card key={index} className={`hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${colorClasses.border}`}>
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2 dark:text-white">{service.title}</h3>
        ...
        {/* Health Packages */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12 dark:text-white">Health Packages & Special Services</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {specializedServices.map((service, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                  <h3 className="text-2xl font-semibold text-gray-900 mb-4 dark:text-white">{service.title}</h3>
        ...
        {/* Additional Services */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12 dark:text-white">Additional Support Services</h2>
              ...
              return (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 mb-2 dark:text-white">{service.title}</h3>
