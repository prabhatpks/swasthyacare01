      ...
      <div className="min-h-screen py-16 flex items-center justify-center">
        <Card className="max-w-md mx-auto">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4 dark:text-white">Appointment Confirmed!</h2>
        ...
        <Card className="max-w-2xl mx-auto">
          <CardContent className="p-8">
            <form onSubmit={handleSubmit}>
              {step === 1 && (
                <>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6 dark:text-white">Step 1: Select Department & Doctor</h2>
              ...
              {step === 2 && (
                <>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6 dark:text-white">Step 2: Patient Information</h2>
              ...
              {step === 3 && (
                <>
                  <h2 className="text-2xl font-bold text-gray-900 mb-6 dark:text-white">Step 3: Additional Information</h2>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-900 mb-2 dark:text-white">Appointment Summary</h4>
