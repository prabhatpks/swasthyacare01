  ...
  return (
    <div className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Department Filter */}
        <div className="mb-12">
          <h3 className="text-lg font-semibold text-gray-900 mb-4 dark:text-white">Filter by Department:</h3>
            ...
            <Card key={index} className="hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardContent className="p-6">
                <div className="text-center mb-4">
                  ...
                  <p className="text-sm text-gray-600 dark:text-white">{doctor.qualification}</p>
                </div>
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-sm text-gray-600 dark:text-white">({doctor.reviews} reviews)</span>
                    </div>
                    <div className="text-lg font-bold text-green-600 dark:text-white">{doctor.fees}</div>
                  </div>

                  <div>
                    <div className="text-sm font-semibold text-gray-900 mb-1 dark:text-white">Specializations:</div>
