    ...
    <div className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 dark:text-white">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-gray-900 mb-2 dark:text-white">{info.title}</h3>
        ...
        <section className="mt-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12 dark:text-white">How to Reach SwasthyaCare</h2>
              ...
              return (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2 dark:text-white">{transport.method}</h3>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">Hospital Location</h3>
              <div className="rounded-lg overflow-hidden h-96">
<div className="rounded-lg overflow-hidden h-96">
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3504.075350263602!2d77.31762507549838!3d28.567499975700407!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjjCsDM0JzAzLjAiTiA3N8KwMTknMTIuNyJF!5e0!3m2!1sen!2sin!4v1753331743028!5m2!1sen!2sin"
    width="100%"
    height="100%"
    style={{ border: 0 }}
    allowFullScreen
  ...
  ></iframe>
        ...
        {/* FAQ Section */}
        <section className="mt-16">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12 dark:text-white">Frequently Asked Questions</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <Card>
                <CardContent className="p-6">
                  <h4 className="font-semibold text-gray-900 mb-2 dark:text-white">What are your visiting hours?</h4>
              ...
              <Card>
                <CardContent className="p-6">
                  <h4 className="font-semibold text-gray-900 mb-2 dark:text-white">Do you accept insurance?</h4>
              ...
              <Card>
                <CardContent className="p-6">
                  <h4 className="font-semibold text-gray-900 mb-2 dark:text-white">How can I book an appointment?</h4>
            ...
            <div className="space-y-6">
              <Card>
                <CardContent className="p-6">
                  <h4 className="font-semibold text-gray-900 mb-2 dark:text-white">Do you provide ambulance services?</h4>
              ...
              <Card>
                <CardContent className="p-6">
                  <h4 className="font-semibold text-gray-900 mb-2 dark:text-white">Is parking available?</h4>
              ...
              <Card>
                <CardContent className="p-6">
                  <h4 className="font-semibold text-gray-900 mb-2 dark:text-white">Do you provide teleconsultation?</h4>
